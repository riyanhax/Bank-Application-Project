					...
					<div id="carousel-slider" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img src="/PROJECTTEAMD/IMAGES/meeting.jpg"
									class="img-responsive" alt="">
							</div>
							<div class="item">
								<img src="/PROJECTTEAMD/IMAGES/tcs-chandrasekaran.jpg"
									class="img-responsive" alt="">
							</div>
						</div>
			...
			<div class="col-sm-6">
				<div class="panel-group">
					<div class="panel panel-primary">
						<div class="panel-heading" style="background-color: #ff751a;">Services</div>
						<div class="panel-body">
							<ul>
								<b>Individual Banking</b> - Checking accounts Savings accounts
								Debit & credit cards Insurance Wealth management
							</ul>
							<ul>
								<b>Business Banking</b> - Business loans Checking accounts
								Savings accounts Debit and credit cards Merchant services
								(credit card processing, reconciliation and reporting, check
								collection) Cash management (payroll services, deposit services,
								etc.)
							</ul>
							<ul>
								<b>Digital Banking</b> - Online, mobile, and tablet banking
								Mobile check deposit Text alerts eStatements Online bill pay
							</ul>
							<ul>
								<b>Loans</b> - Personal loans Home equity loans Home equity
								lines of credit Home loans Business loans
							</ul>
							<ul>
