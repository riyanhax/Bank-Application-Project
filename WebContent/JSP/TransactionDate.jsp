...
<title>Cashier: Transaction Date</title>
<%
		...
		<div class="row profile">
			<div class="col-md-3">
				<div class="profile-sidebar">
					...
					<div class="profile-usermenu">
						<ul class="nav">
							<li class="active"><a class="glyphicon glyphicon-home" href="/PROJECTTEAMD/CashierController?action=transaction"> View Transactions</a></li>

						</ul>
					</div>
					<div class="profile-usermenu">
						<ul class="nav">
							<li class="active"><a class="glyphicon glyphicon-home" href="/PROJECTTEAMD/CashierController?action=cashierhome"> Cashier Home</a></li>
			...
			<div class="col-md-8">
					...
					<form class="form-horizontal" name="myform"
						action="/PROJECTTEAMD/CashierController" method="post">
						<div>
							<div class="col-md-4">
								TRANSACTION START DATE<input type="text" name="startdate"
									ng-model="startdate" id="datepicker" required>
							</div>
							<div class="col-md-4">
								TRANSACTION END DATE<input type="text" name="enddate"
									ng-model="enddate" required id="datepicker1" />
							</div>
							<input type="submit" class="btn btn-success"
								value="ViewTransaction" name="action">
						</div>
					</form>
