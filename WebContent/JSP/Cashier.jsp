	...
	<div class="row">
		<div class="col-xs-12">
			<div class="btn pull-right">
				<b><span ng-bind="ddMMMMyyyy"></span> - {{currentTime | date:'HH:mm:ss'}}</b>
			</div>
		</div>
	</div>
	<div class="container">
		...
		<div class="col-md-8">
					...
					<div class="main-login main-center">
						...
						<form name="myForm" class="form-vertical" action="/PROJECTTEAMD/CashierController" novalidate>

							<label class="radio">CUSTOMER ID 
							<input type="radio" name="select" value="CustomerID" data-toggle="tooltip" data-placement="top" title="Customer ID" checked>
							<span class="checkmark"></span>

							</label> 
							<label class="radio">ACCOUNT ID 
							<input type="radio" name="select" value="AccountID" data-toggle="tooltip" data-placement="top" title="Account ID"> 
							<span class="checkmark"></span>

							</label> 
							<label>
							ENTER ID  <input type="number" ng-model="EID" name="id" id="id" data-toggle="tooltip" data-placement="right" title="Please enter the required ID" required>
							</label>
								...
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" name="submit" value="Go"
										...
										name="reset" class="btn btn-warning" value="Clear">
								</div>
							<br>
							<br>
							<br>
							...
							<input type="hidden" name="action" value="cashiersearch">

						</form>
						<%
							if ((String) request.getAttribute("msg") != null) {
						%>
						<h2 style="color: red"><%=(String) request.getAttribute("msg")%></h2>
