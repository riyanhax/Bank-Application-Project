			...
			<div class="col-sm-6">
				<div class="panel-group">
					<div class="panel panel-primary">
						<div class="panel-heading" style="background-color: #ff751a;">About Us</div>
						<div class="panel-body">
							<p>
							TATA Bank Ltd. is a Universal Bank with its operations driven by a cutting edge core Banking IT platform. The Bank offers personalized banking and financial solutions to its clients in the retail and corporate banking arena through its large network of Branches and ATMs, spread across length and breadth of India. Our experience of financial markets will help us to effectively cope with challenges and capitalize on the emerging opportunities by participating effectively in our countrys growth process.

TATA Bank is the youngest, new generation, public sector universal bank that rides on a cutting edge core banking Information Technology platform. This enables the Bank to offer personalized banking and financial solutions to its clients. The Bank had an aggregate Balance sheet size of Rs.3,74,372 crore and total business of Rs.4,81,613 crore as on March 31, 2016.

Our vision for the Bank is <b>TO BE THE MOST PREFERRED AND TRUSTED BANK ENHANCING VALUE FOR ALL STAKEHOLDERS.</b>
